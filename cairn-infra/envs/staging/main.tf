/**
 * Staging environment: production topology, smaller everything.
 *
 * Same modules and the same shape as prod deliberately — a staging cluster
 * that differs structurally validates nothing.
 *
